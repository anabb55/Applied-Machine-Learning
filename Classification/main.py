...
from nn_classification_sklearn import reduce_dimension, train_nn, train_nn_with_regularization, \
    perform_grid_search, show_confusion_matrix_and_classification_report, plot_training_loss_curve, find_best_model
...
def task_1():
    ...
    final_model = find_best_model(X_train_pca, y_train, best_model_task_1_1, best_gs_nn)
